...
static const uint8_t write_asset_data[ETSS_MAX_ASSET_SIZE] = {0xAF};
static uint8_t read_asset_data[ETSS_MAX_ASSET_SIZE] = {0};
static size_t read_asset_data_len = 0;

/* List of tests */
static void tfm_etss_test_1000(struct test_result_t *ret);
static void tfm_etss_test_1001(struct test_result_t *ret);
static void tfm_etss_test_1002(struct test_result_t *ret);
static void tfm_etss_test_1003(struct test_result_t *ret);
static void tfm_etss_test_1004(struct test_result_t *ret);
static void tfm_etss_test_1005(struct test_result_t *ret);
static void tfm_etss_test_1006(struct test_result_t *ret);
static void tfm_etss_test_1007(struct test_result_t *ret);
static void tfm_etss_test_1008(struct test_result_t *ret);
static void tfm_etss_test_1009(struct test_result_t *ret);
static void tfm_etss_test_1010(struct test_result_t *ret);
static void tfm_etss_test_1011(struct test_result_t *ret);
static void tfm_etss_test_1012(struct test_result_t *ret);
static void tfm_etss_test_1013(struct test_result_t *ret);
static void tfm_etss_test_1014(struct test_result_t *ret);
static void tfm_etss_test_1015(struct test_result_t *ret);
#ifdef TFM_NS_CLIENT_IDENTIFICATION
static void tfm_etss_test_1016(struct test_result_t *ret);
static void tfm_etss_test_1017(struct test_result_t *ret);
static void tfm_etss_test_1018(struct test_result_t *ret);
static void tfm_etss_test_1019(struct test_result_t *ret);
static void tfm_etss_test_1020(struct test_result_t *ret);
#endif /* TFM_NS_CLIENT_IDENTIFICATION */
static void tfm_etss_test_1021(struct test_result_t *ret);
static void tfm_etss_test_1022(struct test_result_t *ret);
static void tfm_etss_test_1023(struct test_result_t *ret);
static void tfm_etss_test_1025(struct test_result_t *ret);

static struct test_t etss_ns_tests[] = {
    {&tfm_etss_test_1000, "TFM_ETSS_TEST_1000",
     "Secure flash provisioning interface"},
    {&tfm_etss_test_1001, "TFM_ETSS_TEST_1001",
     "Set interface"},
    {&tfm_etss_test_1002, "TFM_ETSS_TEST_1002",
     "Set interface with create flags"},
    {&tfm_etss_test_1003, "TFM_ETSS_TEST_1003",
     "Set interface with NULL data pointer"},
    {&tfm_etss_test_1004, "TFM_ETSS_TEST_1004",
     "Set interface with write once UID"},
    {&tfm_etss_test_1005, "TFM_ETSS_TEST_1005",
     "Get interface with valid data"},
    {&tfm_etss_test_1006, "TFM_ETSS_TEST_1006",
     "Get interface with zero data length"},
    {&tfm_etss_test_1007, "TFM_ETSS_TEST_1007",
     "Get interface with invalid UIDs"},
    {&tfm_etss_test_1008, "TFM_ETSS_TEST_1008",
     "Get interface with invalid data lengths and offsets"},
    {&tfm_etss_test_1009, "TFM_ETSS_TEST_1009",
     "Get interface with NULL data pointer"},
    {&tfm_etss_test_1010, "TFM_ETSS_TEST_1010",
     "Get info interface with write once UID"},
    {&tfm_etss_test_1011, "TFM_ETSS_TEST_1011",
     "Get info interface with valid UID"},
    {&tfm_etss_test_1012, "TFM_ETSS_TEST_1012",
     "Get info interface with invalid UIDs"},
    {&tfm_etss_test_1013, "TFM_ETSS_TEST_1013",
     "Remove interface with valid UID"},
    {&tfm_etss_test_1014, "TFM_ETSS_TEST_1014",
     "Remove interface with write once UID"},
    {&tfm_etss_test_1015, "TFM_ETSS_TEST_1015",
     "Remove interface with invalid UID"},
#ifdef TFM_NS_CLIENT_IDENTIFICATION
    {&tfm_etss_test_1016, "TFM_ETSS_TEST_1016",
     "Get interface with invalid thread name"},
    {&tfm_etss_test_1017, "TFM_ETSS_TEST_1017",
     "Get info interface with invalid thread name"},
    {&tfm_etss_test_1018, "TFM_ETSS_TEST_1018",
     "Remove interface with invalid thread name"},
    {&tfm_etss_test_1019, "TFM_ETSS_TEST_1019",
     "Attempt to access UID belonging to another thread"},
    {&tfm_etss_test_1020, "TFM_ETSS_TEST_1020",
     "Set UID alternately from two threads"},
#endif /* TFM_NS_CLIENT_IDENTIFICATION */
    {&tfm_etss_test_1021, "TFM_ETSS_TEST_1021",
     "Block compaction after remove"},
    {&tfm_etss_test_1022, "TFM_ETSS_TEST_1022",
     "Multiple partial gets"},
    {&tfm_etss_test_1023, "TFM_ETSS_TEST_1023",
     "Multiple sets to same UID from same thread"},
    {&tfm_etss_test_1025, "TFM_ETSS_TEST_1025",
...
void register_testsuite_ns_etss_interface(struct test_suite_t *p_test_suite)
{
    ...
    list_size = (sizeof(etss_ns_tests) / sizeof(etss_ns_tests[0]));

    set_testsuite("external trusted secure storage NS interface tests (TFM_ETSS_TEST_1XXX)",
                  etss_ns_tests, list_size, p_test_suite);
}

/* Provisioning data blob structure
    // Major Header
    //DWORD 0: [31:00] signature, "SFPI"
    //DWORD 1: [07:00] version, [23:08] total size, [27:24] sub header number[31:28] sub tabl store number
    
    // Sub Header, ID: 0x00, APP_INFO
    // DWORD 0: [07:00] ID, [15:08] version, [16:16] save:1, not sabe: 0, [31:17] reserved
    // DWORD 1: [15:00] table size, [31:16] table offset
    // Sub Header, ID: 0x01, LOCK_INFO
    // DWORD 0: [07:00] ID, [15:08] version, [16:16] save:1, not sabe: 0, [31:17] reserved
    // DWORD 1: [15:00] table size, [31:16] table offset
    // Sub Header, ID: 0x02, KEY_INFO
    // DWORD 0: [07:00] ID, [15:08] version, [16:16] save:1, not sabe: 0, [31:17] reserved
    // DWORD 1: [15:00] table size, [31:16] table offset
    // Sub Header, ID: 0x03, MC_INFO
    // DWORD 0: [07:00] ID, [15:08] version, [16:16] save:1, not sabe: 0, [31:17] reserved
    // DWORD 1: [15:00] table size, [31:16] table offset
    // Sub Header, ID: 0x04, CONFIG_INFO
    // DWORD 0: [07:00] ID, [15:08] version, [16:16] save:1, not sabe: 0, [31:17] reserved
    // DWORD 1: [15:00] table size, [31:16] table offset

    // APP_INFO Table
    // DWORD  0: [07:00] ID, [15:08] number, [31:23] reserved
    // DWORD  1: [31:00] application id (app0)
    // DWORD  2: [31:00] key id         (app0)
    // DWORD  3: [31:00] application id (app1)
    // DWORD  4: [31:00] key id         (app1)
    // DWORD  5: [31:00] application id (app2)
    // DWORD  6: [31:00] key id         (app2)
    // DWORD  7: [31:00] application id (app3)
    // DWORD  8: [31:00] key id         (app3)

    // LOCK_INFO Table
    // DWORD  0: [07:00] ID, [31:08] reserved
    // DWORD  1: Lock information double word 1
    // DWORD  2: Lock information double word 2

    // KEY_INFO Table
    // DWORD  0: [07:00] ID, [15:08] key number, [31:16] Reserved
    // DWORD  1: [31:00] key id                                                                         (key 0)
    // DWORD  2: [31:00] key derive message                                                             (key 0)
    // DWORD  3: [07:00] key derive params suite, [23:08] key length (in bits), [31:24] key inject type (key 0)
    // DWORD  4: [31:00] key id                                                                         (key 1)
    // DWORD  5: [31:00] key derive message                                                             (key 1)
    // DWORD  6: [07:00] key derive params suite, [23:08] key length (in bits), [31:24] key inject type (key 1)
    // DWORD  7: [31:00] key id                                                                         (key 2)
    // DWORD  8: [31:00] key derive message                                                             (key 2)
    // DWORD  8: [07:00] key derive params suite, [23:08] key length (in bits), [31:24] key inject type (key 2)
    // DWORD 10: [31:00] key id                                                                         (key 3)
    // DWORD 11: [31:00] key derive message                                                             (key 3)
    // DWORD 12: [07:00] key derive params suite, [23:08] key length (in bits), [31:24] key inject type (key 3)

    // MC_INFO Table
    // DWORD 0: [07:00] ID, [15:08] mc number, [31:16] reserved
    // DWORD 1: [31:00] mc value (big endian, mc 0)
    // DWORD 2: [31:00] mc value (big endian, mc 1)
    // DWORD 3: [31:00] mc value (big endian, mc 2)
    // DWORD 4: [31:00] mc value (big endian, mc 3)

    // CONFIG_DATA Table
    // DWORD 0: [07:00] ID, [31:08] reserved
    // DWORD 1 ~ N: Configure data
*/
/* Add your provisioning data here */
const uint8_t provision_data[] = {
};

TFM_ETSS_NS_TEST(1000, "Thread_A")
{
    etss_err_t err;
    const void *p_data = provision_data;
    size_t data_length = sizeof(provision_data);
    TEST_LOG("  > sf provision data length %d\r", data_length);
    err = tfm_etss_secure_flash_provisioning(data_length, p_data);
    if (err != ETSS_SUCCESS) {
        TEST_FAIL("Secure Flash provisioning fail");
        return;
    }
    ret->val = TEST_PASSED;
}
 ...
 */
TFM_ETSS_NS_TEST(1001, "Thread_A")
{
    etss_err_t err;
 ...
 */
TFM_ETSS_NS_TEST(1002, "Thread_A")
{
    etss_err_t err;
 ...
 *
 */
TFM_ETSS_NS_TEST(1003, "Thread_A")
{
	etss_err_t err;
 ...
 */
TFM_ETSS_NS_TEST(1004, "Thread_A")
{
    etss_err_t err;
 ...
 */
TFM_ETSS_NS_TEST(1005, "Thread_A")
{
    etss_err_t err;
    const psa_storage_uid_t uid = TEST_UID_2;
    const psa_storage_create_flags_t flags = PSA_STORAGE_FLAG_NONE;
 ...
 */
TFM_ETSS_NS_TEST(1006, "Thread_A")
{
    etss_err_t err;
    const psa_storage_uid_t uid = TEST_UID_3;
    const psa_storage_create_flags_t flags = PSA_STORAGE_FLAG_NONE;
 ...
 * - Invalid UID
 */
TFM_ETSS_NS_TEST(1007, "Thread_A")
{
    etss_err_t err;
    const psa_storage_uid_t uid = TEST_UID_1;
    ...
    if (err != ETSS_ERR_DOES_NOT_EXIST) {
        TEST_FAIL("Get succeeded with non-existent UID");
        return;
    }
 ...
 */
TFM_ETSS_NS_TEST(1008, "Thread_A")
{
    etss_err_t err;
    const psa_storage_uid_t uid = TEST_UID_2;
    const psa_storage_create_flags_t flags = PSA_STORAGE_FLAG_NONE;
 ...
 *
 */
TFM_ETSS_NS_TEST(1009, "Thread_A")
{
    etss_err_t err;
    const psa_storage_uid_t uid = TEST_UID_3;
    const psa_storage_create_flags_t flags = PSA_STORAGE_FLAG_NONE;
    ...
    err = tfm_etss_get(uid, offset, 0, NULL, &read_data_length);
    if (err != ETSS_SUCCESS) {
 ...
 * - Write once UID
 */
TFM_ETSS_NS_TEST(1010, "Thread_A")
{
    etss_err_t err;
    const psa_storage_uid_t uid = WRITE_ONCE_UID;
 ...
 * - Valid UID
 */
TFM_ETSS_NS_TEST(1011, "Thread_A")
{
    etss_err_t err;
    const psa_storage_uid_t uid = TEST_UID_1;
    struct psa_storage_info_t info = {0};
 ...
 * - Invalid UID
 */
TFM_ETSS_NS_TEST(1012, "Thread_A")
{
    etss_err_t err;
    const psa_storage_uid_t uid = TEST_UID_2;
    struct psa_storage_info_t info = {0};
 ...
 * - Valid UID
 */
TFM_ETSS_NS_TEST(1013, "Thread_A")
{
    etss_err_t err;
    const psa_storage_uid_t uid = TEST_UID_1;
    struct psa_storage_info_t info = {0};
 ...
 * - Write once UID
 */
TFM_ETSS_NS_TEST(1014, "Thread_A")
{
    etss_err_t err;
    const psa_storage_uid_t uid = WRITE_ONCE_UID;
 ...
 * - Invalid UID
 */
TFM_ETSS_NS_TEST(1015, "Thread_A")
{
    etss_err_t err;
 ...
 */
static void tfm_etss_test_1016_task_1(struct test_result_t *ret)
{
    etss_err_t err;
    const psa_storage_uid_t uid = TEST_UID_3;
    const psa_storage_create_flags_t flags = PSA_STORAGE_FLAG_NONE;
 ...
 */
static void tfm_etss_test_1016_task_2(struct test_result_t *ret)
{
    etss_err_t err;
    const psa_storage_uid_t uid = TEST_UID_3;
    const uint32_t data_len = WRITE_DATA_SIZE;
 ...
 */
static void tfm_etss_test_1016_task_3(struct test_result_t *ret)
{
    etss_err_t err;
    const psa_storage_uid_t uid = TEST_UID_3;
...
static void tfm_etss_test_1016(struct test_result_t *ret)
{
    tfm_etss_run_test("Thread_A", ret, tfm_etss_test_1016_task_1);
    if (ret->val != TEST_PASSED) {
        return;
    }

    tfm_etss_run_test(INVALID_THREAD_NAME, ret, tfm_etss_test_1016_task_2);
    if (ret->val != TEST_PASSED) {
        return;
    }

    tfm_etss_run_test("Thread_A", ret, tfm_etss_test_1016_task_3);
}

/**
 * \brief Sets UID with a valid thread name.
 */
static void tfm_etss_test_1017_task_1(struct test_result_t *ret)
{
    etss_err_t err;
    const psa_storage_uid_t uid = TEST_UID_1;
    const psa_storage_create_flags_t flags = PSA_STORAGE_FLAG_NONE;
 ...
 */
static void tfm_etss_test_1017_task_2(struct test_result_t *ret)
{
    etss_err_t err;
    const psa_storage_uid_t uid = TEST_UID_1;
    struct psa_storage_info_t info = {0};
 ...
 * \brief Removes UID with a valid thread name to clean up storage.
 */
static void tfm_etss_test_1017_task_3(struct test_result_t *ret)
{
    etss_err_t err;
    const psa_storage_uid_t uid = TEST_UID_1;
...
static void tfm_etss_test_1017(struct test_result_t *ret)
{
    tfm_etss_run_test("Thread_A", ret, tfm_etss_test_1017_task_1);
    if (ret->val != TEST_PASSED) {
        return;
    }

    tfm_etss_run_test(INVALID_THREAD_NAME, ret, tfm_etss_test_1017_task_2);
    if (ret->val != TEST_PASSED) {
        return;
    }

    tfm_etss_run_test("Thread_A", ret, tfm_etss_test_1017_task_3);
}

/**
 * \brief Sets UID with a valid thread name.
 */
static void tfm_etss_test_1018_task_1(struct test_result_t *ret)
{
    etss_err_t err;
    const psa_storage_uid_t uid = TEST_UID_2;
    const psa_storage_create_flags_t flags = PSA_STORAGE_FLAG_NONE;
 ...
 */
static void tfm_etss_test_1018_task_2(struct test_result_t *ret)
{
    etss_err_t err;
    const psa_storage_uid_t uid = TEST_UID_2;
 ...
 * \brief Removes UID with a valid thread name to clean up storage.
 */
static void tfm_etss_test_1018_task_3(struct test_result_t *ret)
{
    etss_err_t err;
    const psa_storage_uid_t uid = TEST_UID_2;
...
static void tfm_etss_test_1018(struct test_result_t *ret)
{
    tfm_etss_run_test("Thread_A", ret, tfm_etss_test_1018_task_1);
    if (ret->val != TEST_PASSED) {
        return;
    }

    tfm_etss_run_test(INVALID_THREAD_NAME, ret, tfm_etss_test_1018_task_2);
    if (ret->val != TEST_PASSED) {
        return;
    }

    tfm_etss_run_test("Thread_A", ret, tfm_etss_test_1018_task_3);
}

/**
 * \brief Sets UID with first thread.
 */
static void tfm_etss_test_1019_task_1(struct test_result_t *ret)
{
    etss_err_t err;
    const psa_storage_uid_t uid = TEST_UID_3;
    const psa_storage_create_flags_t flags = PSA_STORAGE_FLAG_NONE;
    ...
    err = tfm_etss_set(uid, sizeof(write_data), write_data, flags);
    if (err != ETSS_SUCCESS) {
        TEST_FAIL("Set should not fail with valid UID");
        return;
    }
 ...
 */
static void tfm_etss_test_1019_task_2(struct test_result_t *ret)
{
    etss_err_t err;
    const psa_storage_uid_t uid = TEST_UID_3;
    struct psa_storage_info_t info = {0};
    ...
    err = tfm_etss_get_info(uid, &info);
    if (err != ETSS_ERROR_DOES_NOT_EXIST) {
 ...
 */
static void tfm_etss_test_1019_task_3(struct test_result_t *ret)
{
    etss_err_t err;
    const psa_storage_uid_t uid = TEST_UID_3;
    struct psa_storage_info_t info = {0};
...
static void tfm_etss_test_1019(struct test_result_t *ret)
{
    tfm_etss_run_test("Thread_A", ret, tfm_etss_test_1019_task_1);
    if (ret->val != TEST_PASSED) {
        return;
    }

    tfm_etss_run_test("Thread_B", ret, tfm_etss_test_1019_task_2);
    if (ret->val != TEST_PASSED) {
        return;
    }

    tfm_etss_run_test("Thread_A", ret, tfm_etss_test_1019_task_3);
}

/**
 * \brief Sets TEST_UID_1 from Thread_A.
 */
static void tfm_etss_test_1020_task_1(struct test_result_t *ret)
{
    etss_err_t err;
    const psa_storage_uid_t uid = TEST_UID_1;
    const psa_storage_create_flags_t flags = PSA_STORAGE_FLAG_NONE;
 ...
 */
static void tfm_etss_test_1020_task_2(struct test_result_t *ret)
{
    etss_err_t err;
    const psa_storage_uid_t uid = TEST_UID_1;
    const psa_storage_create_flags_t flags = PSA_STORAGE_FLAG_NONE;
 ...
 */
static void tfm_etss_test_1020_task_3(struct test_result_t *ret)
{
    etss_err_t err;
    const psa_storage_uid_t uid = TEST_UID_1;
    const psa_storage_create_flags_t flags = PSA_STORAGE_FLAG_NONE;
 ...
 */
static void tfm_etss_test_1020_task_4(struct test_result_t *ret)
{
    etss_err_t err;
    const psa_storage_uid_t uid = TEST_UID_1;
    const psa_storage_create_flags_t flags = PSA_STORAGE_FLAG_NONE;
 ...
 */
static void tfm_etss_test_1020_task_5(struct test_result_t *ret)
{
    etss_err_t err;
    const psa_storage_uid_t uid = TEST_UID_1;
    const uint32_t offset = 0;
    ...
    err = tfm_etss_get(uid, offset, sizeof(write_data), read_data,
                        &read_data_len);
    if (err != ETSS_SUCCESS) {
 ...
 */
static void tfm_etss_test_1020_task_6(struct test_result_t *ret)
{
    etss_err_t err;
    const psa_storage_uid_t uid = TEST_UID_1;
    const uint32_t offset = 0;
 ...
 */
static void tfm_etss_test_1020_task_7(struct test_result_t *ret)
{
    etss_err_t err;
    const psa_storage_uid_t uid = TEST_UID_1;
...
static void tfm_etss_test_1020(struct test_result_t *ret)
{
    tfm_etss_run_test("Thread_A", ret, tfm_etss_test_1020_task_1);
    if (ret->val != TEST_PASSED) {
        return;
    }

    tfm_etss_run_test("Thread_B", ret, tfm_etss_test_1020_task_2);
    if (ret->val != TEST_PASSED) {
        return;
    }

    tfm_etss_run_test("Thread_A", ret, tfm_etss_test_1020_task_3);
    if (ret->val != TEST_PASSED) {
        return;
    }

    tfm_etss_run_test("Thread_B", ret, tfm_etss_test_1020_task_4);
    if (ret->val != TEST_PASSED) {
        return;
    }

    tfm_etss_run_test("Thread_A", ret, tfm_etss_test_1020_task_5);
    if (ret->val != TEST_PASSED) {
        return;
    }

    tfm_etss_run_test("Thread_B", ret, tfm_etss_test_1020_task_6);
    if (ret->val != TEST_PASSED) {
        return;
    }

    tfm_etss_run_test("Thread_A", ret, tfm_etss_test_1020_task_7);
}
#endif /* TFM_NS_CLIENT_IDENTIFICATION */
 ...
 */
TFM_ETSS_NS_TEST(1021, "Thread_A")
{
    etss_err_t err;
 ...
 */
TFM_ETSS_NS_TEST(1022, "Thread_A")
{
    etss_err_t err;
    uint32_t i;
    const psa_storage_uid_t uid = TEST_UID_1;
 ...
 */
TFM_ETSS_NS_TEST(1023, "Thread_A")
{
    etss_err_t err;
    const psa_storage_uid_t uid = TEST_UID_2;
    const psa_storage_create_flags_t flags = PSA_STORAGE_FLAG_NONE;
 ...
 * - No flags
 */
TFM_ETSS_NS_TEST(1025, "Thread_A")
{
    uint8_t cycle;
    etss_err_t err;
