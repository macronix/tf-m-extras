 ...
 */
#define TFM_ETSS_TEST_PROTO(test_name) \
 ...
 */
#define TFM_ETSS_TEST_NAME(test_num) CONCAT(tfm_etss_test_, test_num)
 ...
 */
#define TFM_ETSS_TASK_NAME(test_num) CONCAT(TFM_ETSS_TEST_NAME(test_num), _task)
 ...
 * \param[in] test_num  Identification number of the test
 */
#define TFM_ETSS_TEST(test_num) TFM_ETSS_TEST_PROTO(TFM_ETSS_TEST_NAME(test_num))
 ...
 * \param[in] test_num  Identification number of the task
 */
#define TFM_ETSS_TASK(test_num) TFM_ETSS_TEST_PROTO(TFM_ETSS_TASK_NAME(test_num))

/**
 * \brief Defines a single-threaded ETSS NS test function and declares the
 *        corresponding task function.
 *
 * \param[in] test_num     Identification number of the test
 * \param[in] thread_name  Name of the thread in which to run the test
 */
#define TFM_ETSS_NS_TEST(test_num, thread_name)                           \
    TFM_ETSS_TASK(test_num);                                              \
    TFM_ETSS_TEST(test_num)                                               \
    {                                                                    \
        tfm_etss_run_test(thread_name, ret, TFM_ETSS_TASK_NAME(test_num)); \
    }                                                                    \
    TFM_ETSS_TASK(test_num)
 ...
 */
void tfm_etss_run_test(const char *thread_name, struct test_result_t *ret,
