...
#define ETSS_TEST_TASK_STACK_SIZE (768)
                     ...
                     test_func_t *test_func)
{
    ...
    test_semaphore = os_wrapper_semaphore_create(1, 0, "etss_tests_sema");
    if (!test_semaphore) {
    ...
    /* Start test thread */
    thread = os_wrapper_thread_new(thread_name, ETSS_TEST_TASK_STACK_SIZE,
