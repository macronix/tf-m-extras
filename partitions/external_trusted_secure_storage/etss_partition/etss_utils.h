...
#ifndef __ETSS_UTILS_H__
#define __ETSS_UTILS_H__
 ...
 */
#define ETSS_UTILS_ALIGN(x, a) (((x) + ((a) - 1)) & ~((a) - 1))
 ...
 */
#define ETSS_UTILS_IS_ALIGNED(x, a) (((x) & ((a) - 1)) == 0)
